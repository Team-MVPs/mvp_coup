...
1. Fix dependency issues and update to modern tooling
2. Convert JavaScript to TypeScript
3. Convert class components to functional components with hooks
4. Migrate inline/CSS styles to SCSS modules
5. Add mobile responsiveness to all components
...
- Test on both portrait and landscape mobile views

## What to Avoid
- Class components
- Inline styles
- Direct DOM manipulation
- Any usage of deprecated React APIs
```
